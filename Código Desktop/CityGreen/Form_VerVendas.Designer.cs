namespace CityGreen
{
    partial class Form_VerVendas
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)dgw_Item).BeginInit();
            ...
            label8.Location = new Point(49, 205);
            label8.Name = "label8";
            ...
            gb_status.Location = new Point(143, 200);
            ...
            txb_InfoAdicional.Location = new Point(302, 167);
            ...
            label7.Location = new Point(47, 167);
            label7.Name = "label7";
            ...
            lbl_numero.Location = new Point(47, 84);
            ...
            tbx_numero.Location = new Point(156, 80);
            ...
            lbl_cliente.Location = new Point(49, 126);
            ...
            // dgw_Item
            // 
            dgw_Item.AllowUserToAddRows = false;
            dgw_Item.AllowUserToDeleteRows = false;
            dgw_Item.AllowUserToResizeColumns = false;
            dgw_Item.AllowUserToResizeRows = false;
            dgw_Item.Anchor = AnchorStyles.None;
            dgw_Item.BackgroundColor = Color.FromArgb(223, 223, 223);
            dgw_Item.BorderStyle = BorderStyle.None;
            dgw_Item.CellBorderStyle = DataGridViewCellBorderStyle.RaisedHorizontal;
            dgw_Item.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            dgw_Item.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            dgw_Item.ColumnHeadersHeight = 50;
            dgw_Item.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            dgw_Item.Columns.AddRange(new DataGridViewColumn[] { col_IDLote, col_NomeProduto, col_Quantidade, col_Valor, col_Retirar });
            ...
            dgw_Item.DefaultCellStyle = dataGridViewCellStyle2;
            dgw_Item.EnableHeadersVisualStyles = false;
            dgw_Item.GridColor = Color.FromArgb(7, 30, 34);
            dgw_Item.Location = new Point(47, 353);
            dgw_Item.MultiSelect = false;
            dgw_Item.Name = "dgw_Item";
            dgw_Item.ReadOnly = true;
            dgw_Item.RowHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            dgw_Item.RowHeadersDefaultCellStyle = dataGridViewCellStyle3;
            dgw_Item.RowHeadersVisible = false;
            dgw_Item.RowHeadersWidth = 50;
            dgw_Item.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            ...
            dgw_Item.RowsDefaultCellStyle = dataGridViewCellStyle4;
            dgw_Item.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgw_Item.Size = new Size(682, 132);
            dgw_Item.TabIndex = 76;
            dgw_Item.CellContentClick += dgw_Item_CellContentClick;
            // 
            // col_IDLote
            // 
            col_IDLote.HeaderText = "Lote";
            ...
            btn_Adicionar.Location = new Point(556, 305);
            ...
            label10.Location = new Point(45, 274);
            ...
            label11.Location = new Point(47, 315);
            ...
            label12.Location = new Point(283, 315);
            ...
            txb_valor.Location = new Point(364, 314);
            ...
            cbx_Cliente.Location = new Point(143, 127);
            ...
            ((System.ComponentModel.ISupportInitialize)dgw_Item).EndInit();
