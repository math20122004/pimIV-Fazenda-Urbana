...
{
    // Atributos
    public string CNPJ { get; set; } // Chave primária agora
    ...
    public List<Fornecedor> ListarFornecedores(string pesquisa = "")
    {
        ...
        string query = "SELECT cnpj, nome, status, email FROM Fornecedores WHERE nome LIKE @pesquisa OR email LIKE @pesquisa";
    ...
    public Fornecedor VerFornecedor(string cnpj)
    {
        string query = "SELECT * FROM Fornecedores WHERE cnpj = @cnpj";
